...
Подготовить обезличенные тестовые данные
чтобы использовать их в тестировании
...
Функционал: Создать обезличенные тестовые данные

Контекст:
	Дано Я запускаю сценарий открытия TestClient или подключаю уже существующий

Сценарий: Подготовка Справочников
	// Справочник.Валюты
	...
	И я проверяю или создаю для справочника "Организации" объекты:
		...
		| 'e1cib/data/Справочник.Организации?ref=8d34000d8843cd1b11dd2bea12f94c65' | 'False'           | '000000003' | 'Организация ВУ=Нет' | 'False'        |
